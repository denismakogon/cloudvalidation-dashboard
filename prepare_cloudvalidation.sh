...
# It adds Cloudvalidation plugin file to horizon and copies current horizon settings file
# to cloudvalidation direcotory. Thats allows to debug Cloudvalidation Dashboard with
# Django developer server.

DEBUGLVL=2
SCRIPT_DIR=$(cd $(dirname "$0") && pwd)
PLUGIN_FILE="_50_cloudvalidation.py"
...
function copy_config {
    ...
    local dest="${SCRIPT_DIR}/cloudvalidation_dashboard"
...
--dest                | -d  Path to copy cloudvalidation dashboard file
"
